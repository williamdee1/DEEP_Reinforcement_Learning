...
class Basic_env:
    ...
    def __init__(self, game):
        ...
        # Columns equal to the health of the current opposing cpu pokemon (5 buckets of possible health)
        self.col_size = health_buckets_cpu
